...
**Outcome:** An interactive Power BI dashboard with three report pages (National Overview, Trends Over Time, State Comparison/Planning View), backed by a documented, quality-checked dataset, a data dictionary, and a full data-quality log.
...
| Power BI dashboard | Interactive `.pbix` with Overview, Trends, and State Comparison pages | `[add path once exported]` |
